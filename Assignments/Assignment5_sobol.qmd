...
$z_m$ is the height at which wind speed is measured - must be higher than the vegetation (cm), it is usually measured 200 cm above the vegetation
...
Repeat the sensitivity analysis that we have been working on in class BUT lets assume that we are in a different locations - where wind speeds are substantially higher and more variable AND vegetation is shorter - See details below
...
Wind speeds $v$ are normally distributed with a mean of 300 cm/s with a standard deviation of 50 cm/s
...
Plot conductance estimates against wind speed use the parameter that is 2nd in terms of total effect on response
...
-   Graph of relationship between output and wind speed
...
-   Discussion
    ...
    -   correctly identifying how sensitivity to wind speed changed with setting (10pts)
